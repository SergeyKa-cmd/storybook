<template>
  <component :is="tag" :class="className">
    <carousel-navigation v-if="showControls" :top="top" :testimonial="testimonial" :leftIcon="leftIcon" :rightIcon="rightIcon" :floating="floating" :navClass="navClass" @changeSlide="handleChangeSlide"></carousel-navigation>
    ...
    <carousel-navigation :testimonial="testimonial" v-if="showControls" @changeSlide="handleChangeSlide"></carousel-navigation>
  </component>
</template>

<script>
import classNames from 'classnames';
import CarouselNavigation from '../../Advanced/CarouselNavigation';
import CarouselInner from '../../Advanced/CarouselInner';
import CarouselIndicators from '../../Advanced/CarouselIndicators';
import CarouselIndicator from '../../Advanced/CarouselIndicator';
...
const MultiCarousel ={
  ...
  methods: {
    ...
    calculateData() {
      ...
      let itemsNumber = 0;
      if (this.mobile){
        this.$children[2].$children.forEach(child => {
          items.push(child.$el);
          itemsNumber++;
        });
      }
...
export { MultiCarousel as mdbMultiCarousel };
</script>
...
.carousel-multi-item .carousel-control-prev, .carousel-multi-item .carousel-control-next, .carousel-multi-item .carousel-item-prev, .carousel-multi-item .carousel-item-next {
  display: none;
}
</style>
